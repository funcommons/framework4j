...
<dependency>
    ...
    <artifactId>framework4j-core</artifactId>
...
logging:
  level:
    fun.commons.framework4j.openid: DEBUG
    fun.commons.framework4j.id: DEBUG
```
...
**相关文档**:
- [分布式ID SDK使用指南](framework4j%20分布式%20ID%20SDK%20使用指南.md)
