# OpenID 注解数据类型扩展（实现说明）

> **状态**：✅ 已实现（v1.0.0 起）
> **历史**：本文档原为"扩展计划"（§1-10 描述计划阶段），后 §11 为基于实际代码的实现说明。计划已全部落地，现归档为"实现说明"。
> **权威参考**：[`OpenID 模块使用指南.md`](./OpenID%20模块使用指南.md)（用户向）/ [`fun.commons.framework4j.openid`](./src/main/java/fun/commons/framework4j/openid/) 包源码（实现向）
>
> 📖 阅读建议：
> - **使用 OpenID**：直接看《OpenID 模块使用指南.md》
> - **了解已支持的数据类型与架构**：直接跳到 [§11 基于实际代码分析的更新版本](#11-基于实际代码分析的更新版本)
> - §1-10 保留为历史计划记录，不再维护
...
**文件**：
- `framework4j-core/src/main/java//commons/openid/util/OpenIdTypeUtils.java`
- `framework4j-core/src/test/java//commons/openid/util/OpenIdTypeUtilsTest.java`
...
**文件**：
- `framework4j-core/src/main/java//commons/openid/formatter/OpenIdFormatterFactory.java`
...
**文件**：
- `framework4j-core/src/main/java//commons/openid/fastjson2/OpenIdAnnotationFilter.java`
...
**文件**：
- `framework4j-core/src/main/java//commons/openid/jackson/OpenIdJsonSerializer.java`
- `framework4j-core/src/main/java//commons/openid/config/JacksonConfig.java`
...
**文件**：
- `framework4j-core/src/main/java//commons/openid/config/OpenIdSwaggerConfig.java`
...
**文件**：
- `framework4j-core/src/test/java//commons/openid/AllTypesSupportTest.java`
- `framework4j-core/src/test/java//commons/openid/PerformanceTest.java`
...
**文件**：`src/main/java//commons/openid/util/OpenIdTypeUtils.java`
...
// 可选：创建统一配置类
@AutoConfiguration
@ConditionalOnProperty(name = "framework4j.openid.enabled", matchIfMissing = true)
