...
本文档帮助您解决使用 `framework4j-datasource` 时遇到的 SQL TraceID 追踪问题。
...
如果未看到以上日志,请检查:
1. `framework4j-datasource` 依赖是否正确引入
...
logging:
  level:
    fun.commons.framework4j.datasource: DEBUG
...
- [framework4j 分布式 ID SDK 使用指南](../framework4j-id/framework4j 分布式 ID SDK 使用指南.md)
...
- 企业微信: LDX2T 技术支持群
- GitHub Issues: https://github./framework4j-sdk/issues
