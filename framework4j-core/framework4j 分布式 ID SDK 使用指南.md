# ldx2t-commons 分布式 ID SDK 使用指南 (v1.0.0)
...
* 方式 1: 在实体类字段上指定 (推荐)
```java
 import com.ldx2t.commons.id.handler.OpenIdTypeHandler;
...
<result column="id" property="id" typeHandler="handler.id.com.ldx2t.commons.OpenIdTypeHandler"/>
```
...
graph TB
    ...
    App -->|配置| Config["ldx2t.commons.id<br/>worker.redis-name: lockRedis"]
    Config -.->|指定| R3
